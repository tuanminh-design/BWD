    ...
    .map(
      (major) => `
        <tr>
          <td>${major.code}</td>
          <td>${major.name}</td>
          <td>${Number(major.score).toFixed(2)}</td>
        </tr>
      `
    )
    .join("");
    ...
    <section class="content-wrap">
      <div>
        <article class="main-card">
          <h1 class="uni-name">Dai hoc<br><span>Viet - Han (VKU)</span></h1>
          ...
          <div class="tuition">
            ...
            <div class="tuition-grid">
              <div class="tuition-item">
                <div>DAI TRA (STANDARD)</div>
                <strong>${university.standardTuition || "Dang cap nhat"}</strong>
              </div>
              <div class="tuition-item">
                <div>CHUONG TRINH TANG CUONG</div>
        ...
        <article class="scores-card">
          <div class="scores-head">
            <h3>Diem chuan cac nganh 2023</h3>
      ...
      <div class="side-card">
        ...
        <div class="stat"><b>${university.rank || "TOP"}</b><span>Khoi ky thuat & Cong nghe</span></div>
        <div class="stat"><b>${university.employmentRate || "0%"}</b><span>Ty le co viec lam sau 6 thang</span></div>
